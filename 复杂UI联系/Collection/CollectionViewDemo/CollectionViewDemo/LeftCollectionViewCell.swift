...
class LeftCollectionViewCell: UICollectionViewCell {
    ...
    func initView(){
        ...
        titleLabel = UILabel(frame: CGRect(x:5, y:5, width: (self.bounds.size.width-20), height: 40))
        self.addSubview(titleLabel!)
        titleLabel?.backgroundColor = UIColor.lightGray
        
        numLabel = UILabel(frame: CGRect(x: (self.bounds.size.width-30), y: 10, width: 28.3, height: 28.3))
